...
#let titulo = "Redes não orientadas - Gestão de contactos sociais diretos entre habitantes de uma zona residencial "
#let subtitulo = "Trabalho de Grupo I realizado no âmbito da Unidade Curricular de Análise de Redes do 3º ano da Licenciatura em Ciência de Dados"
#let indice= false
// TODO change to grid
// let versao
// let data
